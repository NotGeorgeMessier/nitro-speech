...
namespace margelo::nitro::nitrospeech {
  ...
  public:
    ...
    std::optional<std::function<void(SpeechRecognitionError /* error */, const std::string& /* trace */)>> getOnError() override;
    void setOnError(const std::optional<std::function<void(SpeechRecognitionError /* error */, const std::string& /* trace */)>>& onError) override;
