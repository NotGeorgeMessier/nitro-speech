...
namespace margelo::nitro::nitrospeech {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrospeech/PermissionStatus;";
    ...
    static jni::alias_ref<JPermissionStatus> fromCpp(PermissionStatus value) {
      ...
      switch (value) {
        ...
        case PermissionStatus::NOT_REQUESTED:
          static const auto fieldNOT_REQUESTED = clazz->getStaticField<JPermissionStatus>("NOT_REQUESTED");
          return clazz->getStaticFieldValue(fieldNOT_REQUESTED);
        default:
