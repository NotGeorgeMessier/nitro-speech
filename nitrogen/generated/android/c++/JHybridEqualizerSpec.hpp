...
namespace margelo::nitro::nitrospeech {
  ...
  public:
    struct JavaPart: public jni::JavaClass<JavaPart, JHybridObject::JavaPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrospeech/HybridEqualizerSpec;";
      std::shared_ptr<JHybridEqualizerSpec> getJHybridEqualizerSpec();
    };
    struct CxxPart: public jni::HybridClass<CxxPart, JHybridObject::CxxPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrospeech/HybridEqualizerSpec$CxxPart;";
