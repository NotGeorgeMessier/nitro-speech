///
/// NitroSpeechDevHybridRecognizerSpec.hpp
...
namespace margelo::nitro::nitrospeechdev {
  ...
  class HybridRecognizerSpec: public virtual HybridObject {
    ...
    public:
      // Methods
      virtual void prewarm(const std::optional<SpeechToTextParams>& defaultParams) = 0;
    ...
    protected:
      // Tag for logging
      static constexpr auto TAG = "NitroSpeechDevRecognizer";
  };
