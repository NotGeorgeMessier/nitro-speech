...
namespace margelo::nitro::nitrospeech {
  ...
  /**
   * A struct which can be represented as a JavaScript object (DynamicParams).
   */
...
namespace margelo::nitro {
  ...
  // C++ DynamicParams <> JS DynamicParams (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrospeech::DynamicParams> final {
    static inline margelo::nitro::nitrospeech::DynamicParams fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrospeech::DynamicParams(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrospeech::DynamicParams& arg) {
