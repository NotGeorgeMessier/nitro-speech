...
namespace margelo::nitro::nitrospeech {
  ...
  /**
   * A struct which can be represented as a JavaScript object (Params).
   */
  struct Params {
  public:
...
namespace margelo::nitro {
  ...
  // C++ Params <> JS Params (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrospeech::Params> final {
    static inline margelo::nitro::nitrospeech::Params fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrospeech::Params(
