///
/// NitroSpeechDevSpeechToTextParams.hpp
...
namespace margelo::nitro::nitrospeechdev {
  ...
  public:
    ...
    explicit SpeechToTextParams(std::optional<std::string> locale, std::optional<double> autoFinishRecognitionMs, std::optional<double> autoFinishProgressIntervalMs, std::optional<bool> disableRepeatingFilter, std::optional<std::vector<std::string>> contextualStrings, std::optional<HapticFeedbackStyle> startHapticFeedbackStyle, std::optional<HapticFeedbackStyle> stopHapticFeedbackStyle, std::optional<bool> maskOffensiveWords, std::optional<bool> androidFormattingPreferQuality, std::optional<bool> androidUseWebSearchModel, std::optional<bool> androidDisableBatchHandling, std::optional<bool> iosAddPunctuation, std::optional<IosPreset> iosPreset, std::optional<bool> iosAtypicalSpeech): locale(locale), autoFinishRecognitionMs(autoFinishRecognitionMs), autoFinishProgressIntervalMs(autoFinishProgressIntervalMs), disableRepeatingFilter(disableRepeatingFilter), contextualStrings(contextualStrings), startHapticFeedbackStyle(startHapticFeedbackStyle), stopHapticFeedbackStyle(stopHapticFeedbackStyle), maskOffensiveWords(maskOffensiveWords), androidFormattingPreferQuality(androidFormattingPreferQuality), androidUseWebSearchModel(androidUseWebSearchModel), androidDisableBatchHandling(androidDisableBatchHandling), iosAddPunctuation(iosAddPunctuation), iosPreset(iosPreset), iosAtypicalSpeech(iosAtypicalSpeech) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitrospeechdev::SpeechToTextParams> final {
    static inline margelo::nitro::nitrospeechdev::SpeechToTextParams fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrospeechdev::SpeechToTextParams(
        ...
        JSIConverter<std::optional<margelo::nitro::nitrospeechdev::HapticFeedbackStyle>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "startHapticFeedbackStyle"))),
        JSIConverter<std::optional<margelo::nitro::nitrospeechdev::HapticFeedbackStyle>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "stopHapticFeedbackStyle"))),
        ...
        JSIConverter<std::optional<margelo::nitro::nitrospeechdev::IosPreset>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "iosPreset"))),
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "iosAtypicalSpeech")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrospeechdev::SpeechToTextParams& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "startHapticFeedbackStyle"), JSIConverter<std::optional<margelo::nitro::nitrospeechdev::HapticFeedbackStyle>>::toJSI(runtime, arg.startHapticFeedbackStyle));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "stopHapticFeedbackStyle"), JSIConverter<std::optional<margelo::nitro::nitrospeechdev::HapticFeedbackStyle>>::toJSI(runtime, arg.stopHapticFeedbackStyle));
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "iosPreset"), JSIConverter<std::optional<margelo::nitro::nitrospeechdev::IosPreset>>::toJSI(runtime, arg.iosPreset));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<margelo::nitro::nitrospeechdev::HapticFeedbackStyle>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "startHapticFeedbackStyle")))) return false;
      if (!JSIConverter<std::optional<margelo::nitro::nitrospeechdev::HapticFeedbackStyle>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "stopHapticFeedbackStyle")))) return false;
      ...
      if (!JSIConverter<std::optional<margelo::nitro::nitrospeechdev::IosPreset>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "iosPreset")))) return false;
