...
namespace margelo::nitro::nitrospeech {
  ...
  public:
    ...
    explicit HybridMathSpecSwift(const NitroSpeech::HybridMathSpec_cxx& swiftPart):
      HybridObject(HybridMathSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroSpeech::HybridMathSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroSpeech::HybridMathSpec_cxx _swiftPart;
  };
