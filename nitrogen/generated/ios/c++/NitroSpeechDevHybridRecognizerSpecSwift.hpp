///
/// NitroSpeechDevHybridRecognizerSpecSwift.hpp
...
namespace margelo::nitro::nitrospeechdev {
  ...
  public:
    ...
    explicit HybridRecognizerSpecSwift(const NitroSpeechDev::HybridRecognizerSpec_cxx& swiftPart):
      HybridObject(HybridRecognizerSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroSpeechDev::HybridRecognizerSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  public:
    // Methods
    inline void prewarm(const std::optional<SpeechToTextParams>& defaultParams) override {
  ...
  private:
    NitroSpeechDev::HybridRecognizerSpec_cxx _swiftPart;
  };
