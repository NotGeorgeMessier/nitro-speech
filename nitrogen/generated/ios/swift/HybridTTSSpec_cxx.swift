...
open class HybridTTSSpec_cxx {
  ...
  @inline(__always)
  public final func speak(text: std.string, params: TTSParams) -> bridge.Result_void_ {
    do {
      try self.__implementation.speak(text: String(text), params: params)
  ...
  @inline(__always)
  public final func isSpeaking() -> bridge.Result_std__shared_ptr_Promise_bool___ {
    do {
      let __result = try self.__implementation.isSpeaking()
