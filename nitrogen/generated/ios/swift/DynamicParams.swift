...
/**
 * Represents an instance of `DynamicParams`, backed by a C++ struct.
 */
public typealias DynamicParams = margelo.nitro.nitrospeech.DynamicParams

public extension DynamicParams {
  private typealias bridge = margelo.nitro.nitrospeech.bridge.swift

  /**
   * Create a new instance of `DynamicParams`.
   */
